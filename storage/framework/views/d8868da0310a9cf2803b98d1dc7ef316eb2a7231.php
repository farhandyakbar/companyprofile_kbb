            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- basic form -->
                        <!-- ============================================================== -->
                        <form action="<?php echo e(route('karyawan.store')); ?>" method="POST" id="basicform"
...
<!-- modal  -->
<!-- ============================================================== -->
<?php /**PATH C:\xampp\htdocs\WEB\kp-company_profile_kbb\resources\views/admin/karyawan/create.blade.php ENDPATH**/ ?>