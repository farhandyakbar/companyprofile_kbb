...
<div class="row">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <table class="table table-striped table-bordered first">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button href="<?php echo e(route('karyawan.update', $item->id )); ?>"
                                        class="btn btn-primary" id="editKaryawan" data-id="<?php echo e($item->id); ?>"
                                        data-username="<?php echo e($item->username); ?>"
                                        data-password="<?php echo e($item->password); ?>" 
                                        data-nama="<?php echo e($item->nama); ?>">Edit</button>
                                    <button href="<?php echo e(route('karyawan.destroy', $item->id)); ?>" id="delete"
        ...
        <?php echo $__env->make('admin.karyawan.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin.karyawan.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!-- ============================================================== -->
    <!-- end basic table  -->
    <!-- ============================================================== -->
...
<?php echo $__env->make('templates.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\WEB\kp-company_profile_kbb\resources\views/admin/karyawan/index.blade.php ENDPATH**/ ?>